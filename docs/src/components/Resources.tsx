...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#0000ff]/20 to-[#ffd700]/20 opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#0000ff]/20 dark:to-[#ffd700]/20"
        style={style}
      />
      <motion.div
